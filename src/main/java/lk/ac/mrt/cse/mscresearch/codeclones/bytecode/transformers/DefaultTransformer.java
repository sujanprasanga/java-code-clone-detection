...
public class DefaultTransformer implements Transformer {
	...
	public String transformPrimitiveOp(OpCode o) {
		...
		return o.getCode() + seperator() + o.getTargetClass() + arrayop + newline();
	}
	...
	public String transformInvoke(OpCode o) {
		return o.getCode() + seperator() + o.getTargetClass() + "#" + o.getTargetMethod() + newline();
	}
	...
	public String transformField(OpCode o) {
		return o.getCode() + seperator() + o.getTargetField() + newline();
	}
	
	@Override
	public String transformTypeCheck(OpCode o) {
		return o.getCode() + seperator() + o.getTargetClass() + newline();
	}
